...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2", className)}    {...props}
  />
);
...
export {
  Dialog,  React.ElementRef<typeof DialogPrimitive.Title>,
...
export {
  ...
  DialogTitle,
  DialogDescription,
  DialogClose,>>>>>>> e4fb161c9b387f2138cffabc92159652d110abef
};
