          ...
          return (
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                <div
                  className={`w-10 h-10 rounded-lg bg-${plan.color}-50 dark:bg-${plan.color}-900/20 flex items-center justify-center`}
                >
                  <plan.icon
                    size={20}
                    className={`text-${plan.color}-600 dark:text-${plan.color}-400`}
                  />
                </div>
                <div>
